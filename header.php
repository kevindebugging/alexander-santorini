...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="top-header"><p style="float: left;text-align: left;"><?php if(is_user_logged_in()){$current_user = wp_get_current_user(); echo 'Welcome ' . $current_user->user_firstname;} ?></p><p>Contact us on <?php the_field('phone_number', 4)?> or email <a href="mailto:<?php the_field('email_address', 4)?>"><?php the_field('email_address', 4)?></a></p></div>
